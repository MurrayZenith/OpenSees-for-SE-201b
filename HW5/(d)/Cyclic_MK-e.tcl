...
# revised material properties to 01

# Core concrete:
# uniaxialMaterial Concrete01 $matTag 		 $fpc  $epsc0  $fpcu 			 $epsU 
  uniaxialMaterial Concrete01 $cfconcrete    $f_cc $eps_cc [expr 0.85*$f_cc] -0.0276

# Cover concrete (unconfined):
# uniaxialMaterial Concrete01 $matTag 		 $fpc  $epsc0  $fpcu 			 $epsU 
  uniaxialMaterial Concrete01 $uncfconcrete  $f_c  $eps_c  [expr 0.20*$f_c]  -0.004

# Reinforcing steel
# uniaxialMaterial Steel01 	$matTag $Fy 	$E0 		$b		<$a1 $a2 $a3 $a4> 
  uniaxialMaterial Steel01  $steel  455.0 	215.0e3   	0.01	0.0 1.0 0.0 1.0
...
recorder Node -file Cyclic_e.txt -time -node 2 -dof 1 3 disp
