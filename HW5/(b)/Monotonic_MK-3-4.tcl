...
set Flag 1;
set fileID [open "Monotonic_b4.txt"  "w"]; #this command is used to write an output file
...
set P [expr 0.4*$f_c*$colWidth*$colDepth]; # Based on axial load ratio given in question statement
