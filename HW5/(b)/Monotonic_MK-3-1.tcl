...
set Flag 1;
set fileID [open "Monotonic_b1.txt"  "w"]; #this command is used to write an output file
...
set P [expr 0.1*$f_c*$colWidth*$colDepth]; # Based on axial load ratio given in question statement
