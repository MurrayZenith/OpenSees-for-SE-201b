...
set P [expr 0.3*$f_c*$colWidth*$colDepth]; # Based on axial load ratio given in question statement
...
set d2 [expr 0.021/$colDepth]; # Peak displacement of cycle 2 ------ Value of Kz, NOT Kz.H for Homework #5
set d3 [expr -0.0192/$colDepth]; # Peak displacement of cycle 3 ------ Value of Kz, NOT Kz.H for Homework #5
set d4 [expr 0.0205/$colDepth]; # Peak displacement of cycle 4 ------ Value of Kz, NOT Kz.H for Homework #5


set peakDisp {$d1 $d2 $d3 $d4}; #peak displacement of control DOF for each cycle
