...
for {set i 1} {$i <= $nStory} {incr i 1} {
	...
	element corotTruss [expr 1000*$i + 1] [expr $jNodeTag_1+5] [expr $jNodeTag_2+7] [expr 0.5*$Atruss] $Eqtruss
	element corotTruss [expr 1000*$i + 2] [expr $jNodeTag_1+6] [expr $jNodeTag_2+8] [expr 0.5*$Atruss] $Eqtruss
	element corotTruss [expr 1000*$i + 3] [expr $jNodeTag_2+5] [expr $jNodeTag_1+7] [expr 0.2*$Atruss] $Eqtruss
	element corotTruss [expr 1000*$i + 4] [expr $jNodeTag_2+6] [expr $jNodeTag_1+8] [expr 0.2*$Atruss] $Eqtruss
