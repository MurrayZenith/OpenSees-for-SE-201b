...
if {$ConcMatTypeWall == "Concrete01"} {
  ...
  # uniaxialMaterial Concrete02 $matTag 		 	$fpc	$epsc0	$fpcu				$epsU	$lambda	$ft		$Ets 
	...
	uniaxialMaterial Concrete02 $CConcMatTagWall	$fpcc	$epscc0	[expr 0.85*$fpc]	-0.0276	0.25	$ft		[expr 0.1*$Ec]
}
else {
...
if {$ConcMatTypeBeam == "Concrete01"} {
  ...
  # uniaxialMaterial Concrete02 $matTag 		 	$fpc	$epsc0	$fpcu				$epsU	$lambda	$ft		$Ets 
	uniaxialMaterial Concrete02 $ConcMatTagBeam		$fpc	$epsc0	[expr 0.2*$fpc]		-0.004	0.25	$ft		[expr 0.1*$Ec]
}
else {
...
set fpc     [expr $fyFac*$fyNom];					# Steel strength. fyfac decides expected or nominal
