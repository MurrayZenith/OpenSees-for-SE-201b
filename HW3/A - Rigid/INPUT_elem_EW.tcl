...
for {set i 1} {$i <= $nStory} {incr i 1} {
	...
	rigidLink beam $jNodeTag_1 [expr $jNodeTag_2+3];
	rigidLink beam $jNodeTag_1 [expr $jNodeTag_2+4];
	rigidLink beam $jNodeTag_1 [expr $jNodeTag_2+5];
	rigidLink beam $jNodeTag_1 [expr $jNodeTag_2+6];
	rigidLink beam $jNodeTag_1 [expr $jNodeTag_2+7];
	rigidLink beam $jNodeTag_1 [expr $jNodeTag_2+8];
